...
public class Exercice2125 {
    ...
    private final double y = 275 * Math.pow(10, -3);
    private final double x = 200 * Math.pow(10, -3);
    private Coordinate O, A, B;
    private Vector3D AB, unitVectorAB, T_AB;
    private Matrix T;
    ...
    public Exercice2125() {
        ...
        this.T = new Matrix(new double[][]{{unitVectorAB.y(), -P}});
        double T_AB = T.solve().get("X1");

        System.out.println("========== Tension sur le fil ==========");
        System.out.println(T_AB + " N");

        System.out.println("========== Grandeur de la force Q ==========");
        System.out.println(T_AB * unitVectorAB.z() + " N");
    }
}
