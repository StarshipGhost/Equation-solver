...
public class Exercice4136 {

  private Coordinate A, B, C, D, E, F;
  private Vector3D BF, W;
  ...
  public Exercice4136() {
    ...
    this.BF = F.subtract3DCoordinate(B);
    ...
    this.M_AF = r_AF.crossProduct(BF);
    this.M_AC = r_AC.crossProduct(W);
    this.M_EF = r_EF.crossProduct(BF);
    ...
    double normFD = BF.getForceFromMomentOfForceAboutAnAxis(r_AE, M_AC, r_AF);
